...
@section("home")
<div id="urunler">
    <div style="width:90%; height:40px; border:1px solid #d7d1d1; font-size:20px; color:#837e7e; padding:0 0 0 10%; margin:0 0 0 25px; line-height:35px; border-radius:5px 5px 5px 5px;">Giriş Yap 
        <small id="emailHelp" style="margin:0 0 0 20%; font-size:15px;" class="form-text text-muted">Hesabın yokmu hemen <a style="text-decoration: none;" href="{{Route("kayitol")}}">Kayıt Ol</a></small>
    </div>
...
<div style="width:80%; height:250px; border:0px solid #000; margin:20px auto;">
    <form action="{{Route("girispost")}}" method="POST">
        ...
        <button type="submit" class="btn btn-primary" style="width:70%; margin:20px 0 0 14%;">Giriş Yap</button>
      </form>
</div>
